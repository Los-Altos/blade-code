...
> 💡 首次运行会自动使用内置免费模型 GLM-4.7，无需任何配置即可开始使用。
...
Blade Code 内置了免费的 GLM-4.7 模型，让你无需配置即可体验：

- **模型**: GLM-4.7 Thinking（智谱）
- **特性**: 支持思维链推理
- **上下文**: 204,800 tokens
- **输出**: 16,384 tokens
- **限制**: 由 Blade 团队提供免费额度，适合体验和轻度使用

首次启动时会自动使用内置模型。如需更高性能或更大用量，可配置自己的 API 密钥。

## 🔐 配置自定义模型

如果你想使用自己的 API 密钥，有以下方式：
