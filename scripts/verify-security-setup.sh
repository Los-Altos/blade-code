...
for file in "${SECURITY_FILES[@]}"; do
    if [ -f "/Users/example/Documents/GitHub/Blade/$file" ]; then
        echo "  ✓ $file"
    else
        echo "  ✗ $file (MISSING)"
        ALL_FOUND=false
...
if [ -f "/Users/example/Documents/GitHub/Blade/scripts/run-security-tests.sh" ]; then
    echo "  ✓ Security test script"
    echo "  ✓ Script is executable: $( [ -x "/Users/example/Documents/GitHub/Blade/scripts/run-security-tests.sh" ] && echo "Yes" || echo "No" )"
else
...
if grep -q "security:audit" "/Users/example/Documents/GitHub/Blade/package.json"; then
    echo "  ✓ security:audit command"
else
    echo "  ✗ security:audit command (MISSING)"
fi

if grep -q "security:test" "/Users/example/Documents/GitHub/Blade/package.json"; then
